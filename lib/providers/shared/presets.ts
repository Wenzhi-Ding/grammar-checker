...
export const BUILTIN_PROVIDERS: ProviderEntry[] = [
  ...
  { id: "kimi", label: "Kimi (Moonshot)", adapter: "openai-compatible", baseURL: "https://api.moonshot.cn/v1", apiKey: "", models: ["kimi-k2.6", "kimi-k2.7", "kimi-k2.7-code"], keyUrl: "https://platform.moonshot.cn", builtin: true },
  { id: "glm", label: "GLM (智谱)", adapter: "openai-compatible", baseURL: "https://open.bigmodel.cn/api/paas/v4", apiKey: "", models: ["glm-5.2", "glm-5.2-code", "glm-4-flash", "glm-4-air"], keyUrl: "https://open.bigmodel.cn", builtin: true },
  { id: "glm-zai", label: "GLM (z.ai)", adapter: "openai-compatible", baseURL: "https://api.z.ai/api/paas/v4", apiKey: "", models: ["glm-5.2-code"], keyUrl: "https://z.ai", builtin: true },
