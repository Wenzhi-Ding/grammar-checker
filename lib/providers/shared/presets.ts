...
export const BUILTIN_PROVIDERS: ProviderEntry[] = [
  ...
  { id: "kimi-code", label: "Kimi Code Plan", adapter: "openai-compatible", baseURL: "https://api.kimi.com/coding/v1", apiKey: "", models: ["kimi-k2.7", "kimi-k2.6"], keyUrl: "https://platform.kimi.ai", builtin: true },
